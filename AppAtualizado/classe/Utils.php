...
class Utils
{
    ...
    public static function converterDataParaBrasileiro($dataAmericana)
    {
        // Converte a data americana para um objeto DateTime
        $dataObjeto = new DateTime($dataAmericana);

        // Formata a data para o formato brasileiro
        $dataBrasileira = $dataObjeto->format('d/m/Y');
