...
?> 
  ...
  <body class="container">
    ...
    <div class="mb-3 row mt-4 col-12">
      <label for="inputPassword" class="col-sm-2 col-form-label mx-2 fs-2">Código:</label>
      <div class="col-sm-8">
        <input type="text" class="form-control fs-2" id="id" name="id" placeholder="Digite o ID do Livro">
      </div>
    </div>
 
    <button type="submit" id="btn-deletar" name="btn-deletar"  class="btn btn-primary col-6 fs-2" >Deletar o Livro <i class="bi bi-trash fs-2"></i></button>
