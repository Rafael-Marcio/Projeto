    ...
    <div class="caixa" style="width: 1000px; heigth: 900px; display: flex; flex-direction: column; text-align: center;">
        ...
        <form method="post" style="width: 300xp; heigth: 900px; display: flex; flex-direction: column; justify-content: center; align-items: center; border: 5px solid black; color: white;">
            <div class="entry">
                ...
                <input type="number" name="number2" style="width: 200px; height: 40px; font-size: 30px; text-align: center; margin: 10px;">
                <input type="number" name="number3" style="width: 200px; height: 40px; font-size: 30px; text-align: center; margin: 10px;">
            </div>
            <div class="entry">
                <input type="number" name="number4" style="width: 200px; height: 40px; font-size: 30px; text-align: center; margin: 10px;">
                <input type="number" name="number5" style="width: 200px; height: 40px; font-size: 30px; text-align: center; margin: 10px;">
            </div>
